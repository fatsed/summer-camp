...
@section('content')
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">travel edit Form</h4>
        <div class="card-body">
            <form role="form"  action="/admin/panel/travel/edit.blade.php/{{$travel->TravelId}}" method="post" enctype="multipart/form-data">
                @csrf
