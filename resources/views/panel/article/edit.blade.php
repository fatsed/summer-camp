       ...
       <div class="card">
          <div class="card-body">
             <h4 class="card-title">article edit form</h4>
               <form role="form" action="/admin/panel/article/edit.blade.php/{{$article->id}}" method="post"  enctype="multipart/form-data">
                 @csrf
                  <div class="form-group">
                    <label>img</label>
                    <input name="ArticlePicture" type="file" class="form-control"  value="{{$article->ArticlePicture}}">
                </div>
                <div class="form-group">
                    <label>title</label>
