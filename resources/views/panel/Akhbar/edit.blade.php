    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form role="form" class="forms-sample" method="post"action="/admin/panel/akhbar/edit.blade.php/{{$akhbar->id}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                            <input name="img" type="file" class="form-control" value="{{$akhbar->img}}">
                        </div>
                    </div>
