...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card justify-content-center">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">activites form</h4>
            @if($errors->any())
            ...
            @endif
            <form role="form" class="forms-sample" method="post" action="/admin/panel/activites/create.blade.php" enctype="multipart/form-data">
                @csrf
